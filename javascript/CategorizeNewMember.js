...
//for loop to loop through data array and if statement for specific index ex. if(data[i][0] >= 55) if the looped through arrays 0 index is equal to or greater than 55
